...
class Solution
{
    ...
    Node * bToDLL(Node *root)
    {
        ...
        // Calling the function to convert the binary tree to doubly linked list
    ...
    void convert(Node* root, Node* &head, Node* &prev) {
        ...
        // modifying the left and right pointers along with changing the head and prev pointers
        root->left = prev;
        if (!prev)
            head = root;
        else
